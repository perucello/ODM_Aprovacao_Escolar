...
public class Nota_Semestre_1 {
	...
	public Nota_Semestre_1() {
		super();
	}

	public Nota_Semestre_1(double nota_portugues, double nota_matematica, double nota_historia, double nota_geografia) {
		super();
	...
	public Nota_Semestre_1(double nota_portugues, double nota_matematica, double nota_historia) {
		super();
		this.nota_portugues = nota_portugues;
		this.nota_matematica = nota_matematica;
		this.nota_historia = nota_historia;
	...
	public Nota_Semestre_1(double nota_portugues, double nota_matematica) {
		super();
		this.nota_portugues = nota_portugues;
		this.nota_matematica = nota_matematica;
	}

	public Nota_Semestre_1(double nota_portugues) {
		super();
		this.nota_portugues = nota_portugues;
	}
